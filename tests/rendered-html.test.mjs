...
test("ships MySQL accounts, Netty and cross-platform Bridge capabilities", async () => {
  const [hosting, schema, userSchema, publicPoolSchema, avatarSchema, operationSchema, client, nettyServer, bridge, uninstaller, toolScanRoute, macInstaller, windowsInstaller, macUpdater, windowsUpdater] = await Promise.all([
