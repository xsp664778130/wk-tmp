...
public class InstallController {
    ...
    public record TaskResponse(String id, String skillId, String deviceId, List<String> targets, String status,
        ...
        static TaskResponse from(InstallTaskEntity task) {
            return new TaskResponse(task.getPublicId(), task.getSkillPublicId(), task.getDevicePublicId(),
                    List.of(task.getTargets().split(",")), task.getStatus(), task.getProgress(), task.getStage(),
